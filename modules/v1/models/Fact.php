...
class Fact extends ActiveRecord
{
    ...
    {
        return ['_id', 'child', 'description', 'providence', 'createdAt'];
    }

    public function rules()
    {
        return [
            [['child', 'description', 'providence', 'createdAt'], 'required', 'on' => [self::SCENARIO_CREATE, self::SCENARIO_UPDATE], 'message' => 'Campo obrigatório'],
    ...
    public function _update($data){
        ...
        if($this->validate()){
            ...
            $collection = Yii::$app->mongodb->getCollection('fact');
