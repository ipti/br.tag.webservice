...
public class TAGProject {
	...
	public ArrayList<Student> getStudentsByID(Connection connection, String id) throws Exception {
		try {
			PreparedStatement ps = connection
					.prepareStatement("SELECT * FROM student_identification WHERE id = '" + id + "'");
			ResultSet rs = ps.executeQuery();
